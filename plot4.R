...
GRPDataNumeric <- as.numeric(subrData$Global_reactive_power)
Voltage <- as.numeric(subrData$Voltage)
...
plot(datetime,GAPDataNumeric,type="l",xlab="",ylab="Global Active Power")
...
plot(datetime,GRPDataNumeric,type="l",xlab="datetime",ylab="Global_reactive_power")
